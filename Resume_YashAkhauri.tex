...
%     TITLE NAME
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\namesection{Yash}{Akhauri\hspace{5mm}\includegraphics[width=1.5cm, height=1.5cm]{Resume_YashAkhauri.png}}{
...
\sectionsep 
% \vspace{1mm}
\descript{High-Throughput DNN Inference with LogicNets\\\href{https://www.youtube.com/watch?v=jJRwyHD_UUI}{\texttt{[IEEE \footnote[1]{To be published}]}} {\small Yaman Umuroglu, Yash Akhauri, Nicholas J. Fraser, Michaela Blott} \hfill\texttt{\emph{FCCM'20} | AR, USA | May 2020}}
\sectionsep 
% \vspace{1mm}
